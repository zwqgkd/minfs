# debug
cd /root/project/minfs/workpublish/bin
## kill java
...
start_jar "metaServer-master" "./metaServer/metaServer-1.0.jar" "./metaServer/log/metaServer1.log" "--server.port=8000"
sleep 3
start_jar "metaServer-slave" "./metaServer/metaServer-1.0.jar" "./metaServer/log/metaServer2.log" "--server.port=8001"
